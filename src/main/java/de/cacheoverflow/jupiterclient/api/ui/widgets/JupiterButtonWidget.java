package de.cacheoverflow.jupiterclient.api.ui.widgets;

import com.mojang.blaze3d.systems.RenderSystem;
import de.cacheoverflow.jupiterclient.api.utils.ColorHelper;
import de.cacheoverflow.jupiterclient.api.utils.RenderHelper;
...
public class JupiterButtonWidget extends ButtonWidget {
    ...
    public JupiterButtonWidget(@NotNull final MinecraftClient client, @NotNull final Text text,
    ...
    public JupiterButtonWidget(@NotNull final MinecraftClient client, @NotNull final Text text, @NotNull final Identifier imageId,
    ...
    public void renderButton(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        if (this.lastTimeHovered != this.isHovered())
            this.hoverResetMilliseconds = System.currentTimeMillis();
