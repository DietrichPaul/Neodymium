package de.cacheoverflow.neodymium.impl.screens

import com.mojang.blaze3d.systems.RenderSystem
import de.cacheoverflow.neodymium.Neodymium
import de.cacheoverflow.neodymium.api.ui.ScreenFacade
import de.cacheoverflow.neodymium.api.utils.ButtonHelper
...
class MainMenuScreen(
    ...
    override fun init() {
        //this.ultralight.initGraphicsDriver()
    ...
    override fun render(matrices: MatrixStack, mouseX: Int, mouseY: Int, delta: Float) {
        ...
        // this.ultralight.render(matrices)

        super.render(matrices, mouseX, mouseY, delta)
    }

    companion object {
        @JvmStatic private val LOGO = Identifier(Neodymium::class.simpleName?.lowercase(), "textures/logo/1024x1024.png")
        @JvmStatic private val PLAY_SINGLEPLAYER = Identifier(Neodymium::class.simpleName?.lowercase(), "textures/buttons/play.png")
        @JvmStatic private val SETTINGS = Identifier(Neodymium::class.simpleName?.lowercase(), "textures/buttons/settings.png")
        @JvmStatic private val CLOSE_GAME = Identifier(Neodymium::class.simpleName?.lowercase(), "textures/buttons/back.png")
        @JvmStatic private val ADD_SERVER = Identifier(Neodymium::class.simpleName?.lowercase(), "textures/buttons/add.png")
        @JvmStatic private val DELETE_SERVER = Identifier(Neodymium::class.simpleName?.lowercase(), "textures/buttons/delete.png")
        @JvmStatic private val EDIT_SERVER = Identifier(Neodymium::class.simpleName?.lowercase(), "textures/buttons/edit.png")
